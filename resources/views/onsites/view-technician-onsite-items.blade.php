...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-3 col-md-3 col-sm-12">
            <div class="card">
                <div class="card-body">
                    <h5>Select Technician</h5>
                    <input type="text" class="form-control selectTechnicianSearchBar" placeholder="Search Technician Name...">
                            ...
                            <tbody>
                                ...
                                @forelse(App\Models\User::where('role', 'technician')->get() as $user)
                                    <tr class="selectTechnicianSearchBarResult">
                                        <td class='{{ request()->is('view-technician-onsite-items/'.$user->id) ? 'fw-bold text-success' : '' }}'><a class="nav-link" href="{{ url('/view-technician-onsite-items/'.$user->id) }}">{{ $user->name }}</a></td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td>No Record...</td>
