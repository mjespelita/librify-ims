...
@section('content')
    <div class='row'>
        <div class='col-lg-6 col-md-6 col-sm-12'>
            <h1>Trash Deployedtechnicians</h1>
        </div>
                    ...
                    <tbody>
                        @forelse($deployedtechnicians as $item)
                            <tr>
                                ...
                                <td>
                                    <a href='{{ route('deployedtechnicians.restore', $item->id) }}'><i class='fas fa-recycle text-info'></i></a>
                                </td>
                            </tr>
                        @empty
                            <tr>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.bulk-restore').click(function () {
                ...
                $.post('/deployedtechnicians-restore-all-bulk-data', {
                    ids: array,
                    _token: $("meta[name='csrf-token']").attr('content')
                }, function (res) {
                    console.log(res)
